...
<body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif; color: #cbd5e1; background: #0d1b2e; padding: 32px;">
  <div style="max-width: 600px; margin: 0 auto;">
    ...
    <table style="width: 100%; border-collapse: collapse;">
      ...
      <tr><td style="padding: 12px 16px; border-bottom: 1px solid #1e3a5f; color: #94a3b8; font-size: 12px; text-transform: uppercase;">Phone</td><td style="padding: 12px 16px; border-bottom: 1px solid #1e3a5f; font-size: 14px;">${phone || '—'}</td></tr>
